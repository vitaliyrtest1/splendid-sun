...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6089c5a58b4f370016350910
...
To start editing your site, you can use the Sanity interface at https://splendid-sun-9c5a5.sanity.studio/.
...
Generated at `2021-04-28T20:29:53.979Z` by Stackbit version `0.3.51`.